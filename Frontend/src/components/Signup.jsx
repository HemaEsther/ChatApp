...
const Signup = () => {
    ...
    const { register,handleSubmit,watch,formState: { errors }} = useForm();
        // watch the password and the confirm password fields
  ...
  return (
    ...
    <div className='flex h-screen items-center justify-center'>
        <form onSubmit={handleSubmit(onSubmit)} className='border border-white px-6 py-2 rounded-xl space-y-3 w-96'>
            ...
            <input type="password" className="grow" placeholder="password" {...register("password", { required: true ,validate:validatepasswordmatch})} />
            </label>
